...
export const austinData: LocationPage = {
  ...
  metaTitle: "Media Buying Agency Austin, TX | Google Ads & PPC",
  metaDescription: "Austin's performance marketing experts. Google Ads, Meta & TikTok for Texas tech, ecommerce & local brands. Average 340% ROAS. Free Austin ad audit.",
