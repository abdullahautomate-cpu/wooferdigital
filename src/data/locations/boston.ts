...
export const bostonData: LocationPage = {
  ...
  metaTitle: "Media Buying Agency Boston, MA | Google Ads & PPC",
  metaDescription: "Boston's performance marketing experts. Google Ads, Meta & programmatic for New England healthcare, biotech & finance. Free Boston ad audit.",
