...
export const chicagoData: LocationPage = {
  ...
  metaTitle: "Media Buying Agency Chicago, IL | Google Ads & PPC",
  metaDescription: "Chicago's performance marketing experts. Google Ads, Meta Ads & programmatic for Illinois brands. Average 52% CPL reduction. Free Chicago ad audit.",
