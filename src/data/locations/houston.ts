...
export const houstonData: LocationPage = {
  ...
  metaTitle: "Media Buying Agency Houston, TX | Google Ads & PPC",
  metaDescription: "Houston's performance marketing experts. Google Ads, Meta & programmatic for Texas energy, healthcare & B2B brands. Free Houston ad audit.",
