...
export const miamiData: LocationPage = {
  ...
  metaTitle: "Media Buying Agency Miami, FL | Google Ads & PPC",
  metaDescription: "Miami's bilingual performance marketing experts. Spanish & English Google Ads, Meta & TikTok for South Florida brands. Average 43% CPL reduction. Free Miami audit.",
