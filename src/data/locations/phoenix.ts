...
export const phoenixData: LocationPage = {
  ...
  metaTitle: "Media Buying Agency Phoenix, AZ | Google Ads & PPC",
  metaDescription: "Phoenix's performance marketing experts. Google Ads, Meta & programmatic for Arizona businesses. Average 52% CPL reduction. Free Phoenix ad audit.",
