...
export const sanAntonioData: LocationPage = {
  ...
  metaTitle: "Media Buying Agency San Antonio, TX | Google Ads & PPC",
  metaDescription: "San Antonio's bilingual performance marketing experts. Google Ads, Meta & paid social for Texas businesses. Average 43% CPL reduction. Free SA ad audit.",
