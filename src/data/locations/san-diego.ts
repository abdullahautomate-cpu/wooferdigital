...
export const sanDiegoData: LocationPage = {
  ...
  metaTitle: "Media Buying Agency San Diego, CA | Google Ads & PPC",
  metaDescription: "San Diego's performance marketing experts. Google Ads, Meta & programmatic for healthcare, biotech & defense brands. Free San Diego ad audit.",
